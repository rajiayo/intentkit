...
async def get_supported_standards(
    ...
    """Gets information about supported standards by the Enso Finance API.

    Args:
        api_token (str): Enso Finance API token.

    Returns:
        dict: The API response containing information about supported standards, or raises an exception on error.
    """
